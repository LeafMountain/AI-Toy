...
public class AIMoveComponent : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new MoveSpeed { Value = Speed });
        dstManager.AddComponentData(entity, new MoveForce { Value = Force });
        dstManager.AddComponentData(entity, new Velocity());
        dstManager.AddComponentData(entity, new MoveTarget());
        dstManager.AddComponentData(entity, new AINeighbor());
